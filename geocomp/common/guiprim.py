#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Contém as mesmas funções do modulo geocomp.common.prim, mas desenhando na tela"""
...
def triang (a, b, c):
	"desenha  (e apaga) os lados do triângulo abc"
...
def dist2 (a, b): 
	"retorna o quadrado da distância entre a e b"
...
def area2 (a, b, c):
	"retorna duas vezes a área do triangulo abc"
